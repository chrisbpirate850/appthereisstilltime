...
export function SessionCompletionModal({
  ...
  const handleShare = async (platform: 'twitter' | 'instagram' | 'download') => {
    setIsSharing(true);
          ...
          <div className="space-y-4 mb-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              ...
              <button
                ...
                disabled={isSharing}
                className="flex items-center justify-center gap-2 bg-[#1DA1F2] hover:bg-[#1a8cd8] text-white font-semibold py-3 px-6 rounded-xl transition-smooth disabled:opacity-50"
              >
              ...
              <button
                ...
                disabled={isSharing}
                className="flex items-center justify-center gap-2 bg-gradient-to-r from-[#833AB4] via-[#FD1D1D] to-[#F77737] hover:opacity-90 text-white font-semibold py-3 px-6 rounded-xl transition-smooth disabled:opacity-50"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <button
                ...
                disabled={isSharing}
                className="flex items-center justify-center gap-2 bg-twilight-600 hover:bg-twilight-500 text-white font-semibold py-3 px-6 rounded-xl transition-smooth disabled:opacity-50"
              >
